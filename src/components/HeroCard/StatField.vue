...
<template>
  <div capitalize font-bold flex justify-between gap-1 items-center px-1 w="100%" border="1 gray-100" cursor-pointer hover:bg-black focus:bg-black :class="{ chosenDiscipline: name === localGameStore.localGame.currentDiscipline }" @click="emits('discipline', name)">
